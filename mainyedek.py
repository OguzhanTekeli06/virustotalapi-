...
def home():
    ...
    textAreaUrl = request.args.get('textArea')
    allurls = [url, textAreaUrl]
    if allurls == ['', None]:
    ...
    return render_template('home.html', size=len(allurls), resultVT=resultVT, resultVTjson=resultVTjson)
